  ...
  render() {
    return (
      <div className="animated fadeIn">
        <Row><Col xs="12" md="12"><Card>
              <CardHeader>
              <Row style={({alignItems: "center"})}>
                <Col xs="2"><strong>Register Form</strong> for </Col>
                <Col xs="4"><Input type="select" name="select" id="select">
                  <option disabled selected>Please select</option>
                  <option onClickCapture={()=> console.log('ss')}>Babysitter</option>
                  <option onClick={()=> this.setState({accountType: 'parent'})}>Parent</option>
                </Input>
                </Col></Row>
